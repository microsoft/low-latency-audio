...
// CS_AC_INPUT_TERMINAL_DESCRIPTOR::bmControls
enum
{
	// D1..0: Copy Protect Control
	AC_INPUT_TERMINAL_CONTROL_COPY_PROTECT_CONTROL_READ_ONLY = 0x01,
	AC_INPUT_TERMINAL_CONTROL_COPY_PROTECT_CONTROL_HOST_PROGRAMMABLE = 0x03,
	AC_INPUT_TERMINAL_CONTROL_COPY_PROTECT_CONTROL_MASK = 0x03,

	// D3..2: Connector Control
	AC_INPUT_TERMINAL_CONTROL_CONNECTOR_CONTROL_READ_ONLY = (0x01 << 2),
	AC_INPUT_TERMINAL_CONTROL_CONNECTOR_CONTROL_HOST_PROGRAMMABLE = (0x03 << 2),
	AC_INPUT_TERMINAL_CONTROL_CONNECTOR_CONTROL_MASK = (0x03 << 2),

	// D5..4: Overload Control
	AC_INPUT_TERMINAL_CONTROL_OVERLOAD_CONTROL_READ_ONLY = (0x01 << 4),
	AC_INPUT_TERMINAL_CONTROL_OVERLOAD_CONTROL_HOST_PROGRAMMABLE = (0x03 << 4),
	AC_INPUT_TERMINAL_CONTROL_OVERLOAD_CONTROL_MASK = (0x03 << 4),

	// D7..6: Cluster Control
	AC_INPUT_TERMINAL_CONTROL_CLUSTER_CONTROL_READ_ONLY = (0x01 << 6),
	AC_INPUT_TERMINAL_CONTROL_CLUSTER_CONTROL_HOST_PROGRAMMABLE = (0x03 << 6),
	AC_INPUT_TERMINAL_CONTROL_CLUSTER_CONTROL_MASK = (0x03 << 6),

	// D9..8: Underflow Control
	AC_INPUT_TERMINAL_CONTROL_UNDERFLOW_CONTROL_READ_ONLY = (0x01 << 8),
	AC_INPUT_TERMINAL_CONTROL_UNDERFLOW_CONTROL_HOST_PROGRAMMABLE = (0x03 << 8),
	AC_INPUT_TERMINAL_CONTROL_UNDERFLOW_CONTROL_MASK = (0x03 << 8),

	// D11..10: Overflow Control
	AC_INPUT_TERMINAL_CONTROL_OVERFLOW_CONTROL_READ_ONLY = (0x01 << 10),
	AC_INPUT_TERMINAL_CONTROL_OVERFLOW_CONTROL_HOST_PROGRAMMABLE = (0x03 << 10),
	AC_INPUT_TERMINAL_CONTROL_OVERFLOW_CONTROL_MASK = (0x03 << 10),

	// D13..12: Phantom Power Control
	AC_INPUT_TERMINAL_CONTROL_PHANTOM_POWER_CONTROL_READ_ONLY = (0x01 << 12),
	AC_INPUT_TERMINAL_CONTROL_PHANTOM_POWER_CONTROL_HOST_PROGRAMMABLE = (0x03 << 12),
	AC_INPUT_TERMINAL_CONTROL_PHANTOM_POWER_CONTROL_MASK = (0x03 << 12)
};

// CS_AC_OUTPUT_TERMINAL_DESCRIPTOR::bmControls
enum
{
	// D1..0: Copy Protect Control
	AC_OUTPUT_TERMINAL_CONTROL_COPY_PROTECT_CONTROL_READ_ONLY = 0x01,
	AC_OUTPUT_TERMINAL_CONTROL_COPY_PROTECT_CONTROL_HOST_PROGRAMMABLE = 0x03,
	AC_OUTPUT_TERMINAL_CONTROL_COPY_PROTECT_CONTROL_MASK = 0x03,

	// D3..2: Connector Control
	AC_OUTPUT_TERMINAL_CONTROL_CONNECTOR_CONTROL_READ_ONLY = (0x01 << 2),
	AC_OUTPUT_TERMINAL_CONTROL_CONNECTOR_CONTROL_HOST_PROGRAMMABLE = (0x03 << 2),
	AC_OUTPUT_TERMINAL_CONTROL_CONNECTOR_CONTROL_MASK = (0x03 << 2),

	// D5..4: Overload Control
	AC_OUTPUT_TERMINAL_CONTROL_OVERLOAD_CONTROL_READ_ONLY = (0x01 << 4),
	AC_OUTPUT_TERMINAL_CONTROL_OVERLOAD_CONTROL_HOST_PROGRAMMABLE = (0x03 << 4),
	AC_OUTPUT_TERMINAL_CONTROL_OVERLOAD_CONTROL_MASK = (0x03 << 4),

	// D7..6: Underflow Control
	AC_OUTPUT_TERMINAL_CONTROL_UNDERFLOW_CONTROL_READ_ONLY = (0x01 << 6),
	AC_OUTPUT_TERMINAL_CONTROL_UNDERFLOW_CONTROL_HOST_PROGRAMMABLE = (0x03 << 6),
	AC_OUTPUT_TERMINAL_CONTROL_UNDERFLOW_CONTROL_MASK = (0x03 << 6),

	// D9..8: Overflow Control
	AC_OUTPUT_TERMINAL_CONTROL_OVERFLOW_CONTROL_READ_ONLY = (0x01 << 8),
	AC_OUTPUT_TERMINAL_CONTROL_OVERFLOW_CONTROL_HOST_PROGRAMMABLE = (0x03 << 8),
	AC_OUTPUT_TERMINAL_CONTROL_OVERFLOW_CONTROL_MASK = (0x03 << 8)
};
...
enum
{
	INTERRUPT_INFO_KIND_CLASS = (0x00 << 0),
	INTERRUPT_INFO_KIND_VENDOR_SPECIFIC = (0x01 << 0),
	INTERRUPT_INFO_KIND_MASK = (0x01 << 0),

	INTERRUPT_INFO_ORIGIN_INTERFACE = (0x00 << 1),
	INTERRUPT_INFO_ORIGIN_ENDPOINT = (0x01 << 1),
	INTERRUPT_INFO_ORIGIN_MASK = (0x01 << 1)
};

enum {
	INTERRUPT_INDEX_ENDPOINT_MASK = (0xff),
	INTERRUPT_INDEX_INTERFACENUMBER_MASK = (0xff),
	INTERRUPT_INDEX_ENTITYID_SHIFT = (8),
};

enum {
	INTERRUPT_VALUE_CONTROL_NUMBER_MASK = (0xff),
	INTERRUPT_VALUE_CONTROL_SELECTOR_SHIFT = (8)
};
