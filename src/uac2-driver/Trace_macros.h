...
#define WPP_CONDITIONAL_LEVEL_FLAGS_OVERRIDE(LEVEL, FLAGS, HR)        \
    ...
    __pragma(warning(push))                                           \
        __pragma(warning(disable : 4127)) if (LEVEL == LEVEL_COND)    \
    {                                                                 \
        if (SUCCEEDED(HR))                                            \
        {                                                             \
...
#define WPP_LEVEL_FLAGS_HR_PRE(LEVEL, FLAGS, HR) \
    {                                            \
        WPP_CONDITIONAL_LEVEL_FLAGS_OVERRIDE(LEVEL, FLAGS, HR)
...
#define WPP_LEVEL_FLAGS_STATUS_PRE(LEVEL, FLAGS, STATUS) \
    {                                                    \
        WPP_CONDITIONAL_LEVEL_FLAGS_OVERRIDE_NTSTATUS(LEVEL, FLAGS, STATUS)
...
#define WPP_LEVEL_FLAGS_RETSTATUS_PRE(LEVEL, FLAGS, RETSTATUS) \
    do                                                         \
    {                                                          \
        NTSTATUS __statusRet = (RETSTATUS);                    \
        if (FAILED_NTSTATUS(__statusRet))                      \
        {
#define WPP_LEVEL_FLAGS_RETSTATUS_POST(LEVEL, FLAGS, RETSTATUS) \
    ;                                                           \
    return __statusRet;                                         \
    }                                                           \
    }                                                           \
...
#define WPP_LEVEL_FLAGS_IFRLOG_RETSTATUS_ALLOWEDSTATUS_PRE(LEVEL, FLAGS, IFRLOG, RETSTATUS, ALLOWEDSTATUS) \
    do                                                                                                     \
    {                                                                                                      \
        NTSTATUS __statusRet = (RETSTATUS);                                                                \
        ...
        if (FAILED_NTSTATUS(__statusRet))                                                                  \
        {
#define WPP_LEVEL_FLAGS_IFRLOG_RETSTATUS_ALLOWEDSTATUS_POST(LEVEL, FLAGS, IFRLOG, RETSTATUS, ALLOWEDSTATUS) \
    ;                                                                                                       \
    return __statusRet;                                                                                     \
    }                                                                                                       \
    }                                                                                                       \
...
#define WPP_LEVEL_FLAGS_RETPTR_PRE(LEVEL, FLAGS, RETPTR) \
    do                                                   \
    {                                                    \
        if ((RETPTR) == nullptr)                         \
        {
#define WPP_LEVEL_FLAGS_RETPTR_POST(LEVEL, FLAGS, RETPTR) \
    ;                                                     \
...
#define WPP_LEVEL_FLAGS_RETSTATUS_RETPTR_PRE(LEVEL, FLAGS, RETSTATUS, RETPTR) \
    do                                                                        \
    {                                                                         \
        NTSTATUS __statusRet = (RETSTATUS);                                   \
        if ((RETPTR) == nullptr)                                              \
        {
#define WPP_LEVEL_FLAGS_RETSTATUS_RETPTR_POST(LEVEL, FLAGS, RETSTATUS, RETPTR) \
    ;                                                                          \
    return __statusRet;                                                        \
    }                                                                          \
    }                                                                          \
...
#define WPP_LEVEL_FLAGS_RETSTATUS_POSCOND_PRE(LEVEL, FLAGS, RETSTATUS, POSCOND) \
    do                                                                          \
    {                                                                           \
        NTSTATUS __statusRet = (RETSTATUS);                                     \
        if ((POSCOND))                                                          \
        {
#define WPP_LEVEL_FLAGS_RETSTATUS_POSCOND_POST(LEVEL, FLAGS, RETSTATUS, POSCOND) \
    ;                                                                            \
    return __statusRet;                                                          \
    }                                                                            \
    }                                                                            \
...
#define WPP_LEVEL_FLAGS_RETSTATUS_NEGCOND_PRE(LEVEL, FLAGS, RETSTATUS, NEGCOND) \
    do                                                                          \
    {                                                                           \
        NTSTATUS __statusRet = (RETSTATUS);                                     \
        if (!(NEGCOND))                                                         \
        {
#define WPP_LEVEL_FLAGS_RETSTATUS_NEGCOND_POST(LEVEL, FLAGS, RETSTATUS, NEGCOND) \
    ;                                                                            \
    return __statusRet;                                                          \
    }                                                                            \
    }                                                                            \
...
#define WPP_RECORDER_CONDITIONAL_LEVEL_FLAGS_OVERRIDE(LEVEL, FLAGS, HR) \
    ((LEVEL == LEVEL_COND) ? (FAILED(HR) ? WPP_RECORDER_LEVEL_FLAGS_FILTER(LEVEL_ERROR, FLAGS) : WPP_RECORDER_LEVEL_FLAGS_FILTER(LEVEL_VERBOSE, FLAGS)) : WPP_RECORDER_LEVEL_FLAGS_FILTER(LEVEL, FLAGS))

#define WPP_RECORDER_CONDITIONAL_LEVEL_FLAGS_OVERRIDE_NTSTATUS(LEVEL, FLAGS, STATUS) \
    ((LEVEL == LEVEL_COND) ? (FAILED_NTSTATUS(STATUS) ? WPP_RECORDER_LEVEL_FLAGS_FILTER(LEVEL_ERROR, FLAGS) : WPP_RECORDER_LEVEL_FLAGS_FILTER(LEVEL_VERBOSE, FLAGS)) : WPP_RECORDER_LEVEL_FLAGS_FILTER(LEVEL, FLAGS))
...
void TraceEvents(LEVEL, FLAGS, MSG, ...);
...
//
// begin_wpp config
// FUNC Trace{FLAGS=FLAG_DEVICE_ALL}(LEVEL, MSG, ...);
